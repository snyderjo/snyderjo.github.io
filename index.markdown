...
<tr>
    <td>
        <div>
            <p style="text-align:center">I have found it indispensable for code development, as well as enabling collaboration like no other tool.  I do my best to share my code (including <a href="https://github.com/snyderjo/snyderjo.github.io">this website</a>) via git and github.</p>
        </div>
    </td>
    <td >
        <div>
